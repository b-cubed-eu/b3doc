...
This outlines how to propose a change to b3doc. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("b-cubed-eu/b3doc", fork = TRUE)`.
...
Please note that the b3doc project is released with a [Contributor Code
of Conduct](https://b-cubed-eu.github.io/b3doc/CODE_OF_CONDUCT.md). By
