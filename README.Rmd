...
This is an example of how `b3doc` can be used in [b-cubed-eu/documentation](https://github.com/b-cubed-eu/documentation/tree/main). The example shows how to convert an R Markdown file to a Markdown file with the necessary metadata for the [B-Cubed documentation website](https://docs.b-cubed.eu) website.
